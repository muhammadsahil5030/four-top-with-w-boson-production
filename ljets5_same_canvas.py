...
h1 = fIn1.Get("jet_pt_5")
h2 = fIn2.Get("jet_pt_5")
h3 = fIn3.Get("jet_pt_5")
h4 = fIn4.Get("jet_pt_5")
h5 = fIn5.Get("jet_pt_5")
...
#h5.SetLineWidth(2)
h2.SetStats(0)
h2.SetTitle("6th Leading Jet P_{T}")
h2.GetXaxis().SetTitle("Pt_{j} [GeV]")
h2.GetYaxis().SetTitle("Normalized")
h2.GetYaxis().SetRangeUser(0, 0.40)
