...
h5 = fIn1.Get("down_quark0_pt")
h4 = fIn1.Get("down_quark1_pt")
h3 = fIn1.Get("down_quark2_pt")
h2 = fIn1.Get("down_quark3_pt")
h1 = fIn1.Get("down_quark4_pt")
hPt = fIn1.Get("hPt_down")
hEta = fIn1.Get("hEta_down")
hPhi = fIn1.Get("hPhi_down")
...
#canvas = ROOT.TCanvas("canvas", "Down Quarks Kinematics", 800, 600)
#canvas.Divide(2,2)

#----------------------------------*plot Pt*--------------------------------------------
#canvas.cd(1)
canvas1 = ROOT.TCanvas("canvas1", "Down Quarks Kinematics", 800, 600)
hPt.SetLineWidth(2)
hPt.SetLineColor(ROOT.kBlack)
hPt.SetStats(0)
hPt.SetTitle("Down Quark")
...
tex2.Draw()
canvas1.Draw()
canvas1.SaveAs("/home/msahil/work/analysis/fourtop_wminus/presentation_1/presentation_images/partons_plots/pt_down_quarks.png")

#----------------------------*plot leading subleading Pt*-------------------------
#canvas.cd(2)
canvas2 = ROOT.TCanvas("canvas2", "Down Quarks Kinematics", 800, 600)
...
h5.SetLineWidth(2)
h5.SetStats(0)
h5.SetTitle("Leading Down Quarks")
...
legend.Draw()
canvas2.Draw()
canvas2.SaveAs("/home/msahil/work/analysis/fourtop_wminus/presentation_1/presentation_images/partons_plots/leading_down_quarks.png")

#---------------------------------*plot Eta*-------------------------------------
#canvas.cd(3)
canvas3 = ROOT.TCanvas("canvas3", "Down Quarks Kinematics", 800, 600)
hEta.SetLineWidth(2)
hEta.SetLineColor(ROOT.kRed)
hEta.SetStats(0)
hEta.SetTitle("Down Quark")
...
tex6.Draw()
canvas3.Draw()
canvas3.SaveAs("/home/msahil/work/analysis/fourtop_wminus/presentation_1/presentation_images/partons_plots/eta_down_quarks.png")

#------------------------------*plot Phi*----------------------------------
#canvas.cd(4)
canvas4 = ROOT.TCanvas("canvas4", "Down Quarks Kinematics", 800, 600)
hPhi.SetLineWidth(2)
hPhi.SetLineColor(ROOT.kRed)
hPhi.SetStats(0)
hPhi.SetTitle("Down Quark")
...
tex8.Draw()
canvas4.Draw()
canvas4.SaveAs("/home/msahil/work/analysis/fourtop_wminus/presentation_1/presentation_images/partons_plots/phi_down_quarks.png")


#-------------------------------------- *Show the canvas* -----------------------------
#canvas.SetLogy()
#canvas.Draw()
#canvas.SaveAs("plots/dquarks.png")
