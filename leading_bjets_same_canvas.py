...
h1 = fIn1.Get("b_jet_pt_0")
h2 = fIn2.Get("b_jet_pt_0")
h3 = fIn3.Get("b_jet_pt_0")
h4 = fIn4.Get("b_jet_pt_0")
h5 = fIn5.Get("b_jet_pt_0")
...
#h5.SetLineWidth(2)
h2.SetStats(0)
h2.SetTitle("Leading b-jet P_{T}")
h2.GetXaxis().SetTitle("Pt_{bj} [GeV]")
h2.GetYaxis().SetTitle("Normalized")
h2.GetYaxis().SetRangeUser(0,0.25)
