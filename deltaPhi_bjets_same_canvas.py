...
h1 = fIn1.Get("hdphi_bjets")
h2 = fIn2.Get("hdphi_bjets")
h3 = fIn3.Get("hdphi_bjets")
h4 = fIn4.Get("hdphi_bjets")
h5 = fIn5.Get("hdphi_bjets")
...
#h5.SetLineWidth(2)
h2.SetStats(0)
h2.SetTitle("Delta Eta")
h2.GetXaxis().SetTitle("#Delta#phi bjet")
