...
h5 = fIn1.Get("charm_quark0_pt")
h4 = fIn1.Get("charm_quark1_pt")
h3 = fIn1.Get("charm_quark2_pt")
h2 = fIn1.Get("charm_quark3_pt")
h1 = fIn1.Get("charm_quark4_pt")
hPt = fIn1.Get("hPt_charm")
hEta = fIn1.Get("hEta_charm")
hPhi = fIn1.Get("hPhi_charm")
...
#canvas = ROOT.TCanvas("canvas", "Charm Quarks Kinematics", 800, 600)
#canvas.Divide(2,2)

#----------------------------------*plot Pt*--------------------------------------------
#canvas.cd(1)
canvas1 = ROOT.TCanvas("canvas1", "Charm Quarks Kinematics", 800, 600)
hPt.SetLineWidth(2)
hPt.SetLineColor(ROOT.kBlack)
hPt.SetStats(0)
hPt.SetTitle("Charm Quark")
...
tex2.Draw()
canvas1.Draw()
canvas1.SaveAs("/home/msahil/work/analysis/fourtop_wminus/presentation_1/presentation_images/partons_plots/pt_charm_quarks.png")

#----------------------------*plot leading subleading Pt*-------------------------
#canvas.cd(2)
canvas2 = ROOT.TCanvas("canvas2", "Charm Quarks Kinematics", 800, 600)
...
h5.SetLineWidth(2)
h5.SetStats(0)
h5.SetTitle("Leading Charm Quarks")
...
legend.Draw()
canvas2.Draw()
canvas2.SaveAs("/home/msahil/work/analysis/fourtop_wminus/presentation_1/presentation_images/partons_plots/leading_cquarks_pt.png")

#---------------------------------*plot Eta*-------------------------------------
#canvas.cd(3)
canvas3 = ROOT.TCanvas("canvas3", "Charm Quarks Kinematics", 800, 600)
hEta.SetLineWidth(2)
hEta.SetLineColor(ROOT.kRed)
hEta.SetStats(0)
hEta.SetTitle("Charm Quark")
...
tex6.Draw()
canvas3.Draw()
canvas3.SaveAs("/home/msahil/work/analysis/fourtop_wminus/presentation_1/presentation_images/partons_plots/eta_charm_quarks.png")

#------------------------------*plot Phi*----------------------------------
#canvas.cd(4)
canvas4 = ROOT.TCanvas("canvas4", "Charm Quarks Kinematics", 800, 600)
hPhi.SetLineWidth(2)
hPhi.SetLineColor(ROOT.kRed)
hPhi.SetStats(0)
hPhi.SetTitle("Charm Quark")
...
tex8.Draw()
canvas4.Draw()
canvas4.SaveAs("/home/msahil/work/analysis/fourtop_wminus/presentation_1/presentation_images/partons_plots/phi_charm_quarks.png")

#-------------------------------------- *Show the canvas* -----------------------------
#canvas.SetLogy()
#canvas.Draw()
#canvas.SaveAs("plots/cquarks.png")
